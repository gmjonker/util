...
import static cn.yxffcode.freetookit.utils.StringUtils.equalsIgnoreCase;
...
public class IgnoreCaseStringMap<V> extends AbstractMap<String, V> implements Serializable, Cloneable {
  ...
  private static final class EntrySetWrapper<V> extends AbstractSet<Entry<String, V>> {
    ...
    private static final class TransformEntry<V> implements Entry<String, V> {

      private final Entry<StringHolder, V> delegate;
