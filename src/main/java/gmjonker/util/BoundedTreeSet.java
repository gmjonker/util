 ...
 */
public class BoundedTreeSet<E extends Comparable<? super E>> extends TreeSet<E> 
{
    ...
    public BoundedTreeSet(int maxSize, boolean ascending)
    {
        super(ascending ? Comparator.naturalOrder() : Comparator.reverseOrder());
        this.setMaxSize(maxSize);
    }

//    public BoundedTreeSet(int maxSize, Function<? extends E, ? extends Comparable> compareKeyExtractor)
//    {
//        Comparator<? super E> comparing = Comparator.<E,>comparing(compareKeyExtractor);
//        this(maxSize, );
////        this.setMaxSize(maxSize);
//    }
